#!/usr/bin/env bash
# test-coreutils.sh — Automated GNU coreutils 9.9 test suite for elfuse
#
...
#
# Tests all 104 coreutils through elfuse, verifying each tool can at least
...
coreutils_print_suite_header "GNU coreutils 9.9 test suite"
...
coreutils_print_summary "Results"
