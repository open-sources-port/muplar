// platform/android-aarch64/jni/jni_env.cpp
#include "jni_env.h"
...
uint64_t JniEnv::dispatch(uint32_t call_nr, const uint64_t args[8])
{
    switch (call_nr) {
    case JNI_GetVersion:
        return jni_GetVersion(args);
    case JNI_FindClass:
        return jni_FindClass(args);
    case JNI_RegisterNatives:
        return jni_RegisterNatives(args);
    case JNI_GetMethodID:
        return jni_GetMethodID(args);
    case JNI_CallVoidMethod:
        return jni_CallVoidMethod(args);
    case JNI_CallIntMethod:
        return jni_CallIntMethod(args);
    case JNI_NewStringUTF:
        return jni_NewStringUTF(args);
    case JNI_GetStringUTFChars:
        return jni_GetStringUTFChars(args);
    case JNI_ReleaseStringUTFChars:
        return jni_ReleaseStringUTFChars(args);
    case JNI_NewByteArray:
        return jni_NewByteArray(args);
    case JNI_SetByteArrayRegion:
        return jni_SetByteArrayRegion(args);
    case JNI_GetByteArrayElements:
        return jni_GetByteArrayElements(args);
    case JNI_ReleaseByteArrayElements:
        return jni_ReleaseByteArrayElements(args);
    case JNI_ExceptionCheck:
        return jni_ExceptionCheck(args);
    case JNI_ExceptionClear:
        return jni_ExceptionClear(args);
    case JNI_DeleteLocalRef:
        return jni_DeleteLocalRef(args);
    case JNI_GetObjectClass:
        return jni_GetObjectClass(args);
    case JNI_CallObjectMethod:
        return jni_CallObjectMethod(args);
    case JNI_GetFieldID:
        return jni_GetFieldID(args);
    case JNI_ExceptionOccurred:
        return jni_ExceptionOccurred(args);
    case JNI_ExceptionDescribe:
        return jni_ExceptionDescribe(args);
    case JNI_PushLocalFrame:
        return jni_PushLocalFrame(args);
    case JNI_PopLocalFrame:
        return jni_PopLocalFrame(args);
    case JNI_NewGlobalRef:
        return jni_NewGlobalRef(args);
    case JNI_DeleteGlobalRef:
        return jni_DeleteGlobalRef(args);
    case JNI_IsSameObject:
        return jni_IsSameObject(args);
    case JNI_NewLocalRef:
        return jni_NewLocalRef(args);
    case JNI_EnsureLocalCapacity:
        return jni_EnsureLocalCapacity(args);
    case JNI_NewDirectByteBuffer:
        return jni_NewDirectByteBuffer(args);
    case JNI_GetDirectBufferAddress:
        return jni_GetDirectBufferAddress(args);
    case JNI_GetDirectBufferCapacity:
        return jni_GetDirectBufferCapacity(args);
    case JNI_GetArrayLength:
        return jni_GetArrayLength(args);
    case JNI_NewObjectArray:
        return jni_NewObjectArray(args);
    case JNI_GetObjectArrayElement:
        return jni_GetObjectArrayElement(args);
    case JNI_SetObjectArrayElement:
        return jni_SetObjectArrayElement(args);
    case JNI_NewIntArray:
        return jni_NewIntArray(args);
    case JNI_NewLongArray:
        return jni_NewLongArray(args);
    case JNI_NewFloatArray:
        return jni_NewFloatArray(args);
    case JNI_GetIntArrayElements:
        return jni_GetIntArrayElements(args);
    case JNI_GetLongArrayElements:
        return jni_GetLongArrayElements(args);
    case JNI_GetFloatArrayElements:
        return jni_GetFloatArrayElements(args);
    case JNI_ReleaseIntArrayElements:
        return jni_ReleaseIntArrayElements(args);
    case JNI_ReleaseLongArrayElements:
        return jni_ReleaseLongArrayElements(args);
    case JNI_ReleaseFloatArrayElements:
        return jni_ReleaseFloatArrayElements(args);
    case JNI_GetIntArrayRegion:
        return jni_GetIntArrayRegion(args);
    case JNI_GetLongArrayRegion:
        return jni_GetLongArrayRegion(args);
    case JNI_GetFloatArrayRegion:
        return jni_GetFloatArrayRegion(args);
    case JNI_SetIntArrayRegion:
        return jni_SetIntArrayRegion(args);
    case JNI_SetLongArrayRegion:
        return jni_SetLongArrayRegion(args);
...
std::vector<std::pair<int, uint64_t>> JniEnv::install_entries(
...
{
    if (class_by_desc_.count(descriptor))
        return;
                                       ...
                                       jobject initial)
{
    ...
    if (desc[0] != '[' && !(desc.front() == 'L' && desc.back() == ';'))
        desc = "L" + desc + ";";
...
jobject JniEnv::make_direct_buffer(uint64_t guest_address, uint64_t capacity)
{
    ...
    uint64_t h = alloc_handle();
    objects_[h] = {find_class("java/nio/DirectByteBuffer"), guest_address,
                   capacity};
    return h;
}
...
// Convention: args[0] = JNIEnv* (ignored — we are the env), args[1..] = real
// args
// ────────────────────────────────────────────────────────────────────────────
...
uint64_t JniEnv::jni_GetObjectClass(const uint64_t *a)
{
    ...
    if (oit == objects_.end() && classes_.count(obj)) {
