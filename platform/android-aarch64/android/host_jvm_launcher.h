...
struct HostJvmLaunchConfig {
    ...
    std::string apk_path;
    std::filesystem::path resource_apk_path;
    std::string package_name;
    std::string application_class;
    std::string launch_activity;

    // Per-prefix package metadata generated by the native APK parser.
    std::filesystem::path package_registry;

    // Native launcher and prefix used for explicit Intent dispatch.
