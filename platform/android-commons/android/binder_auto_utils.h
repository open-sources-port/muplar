...
public:
    ...
    /**
     * Convenience operator for implicitly constructing an SpAIBinder from
     * nullptr. This is not explicit because it is not taking ownership of
     * anything.
     */
    ...
    /**
     * This takes ownership of a binder from another AIBinder object but it does
     * not affect the ownership of that other object.
     */
    ...
    /**
     * This returns the underlying binder object for transactions. If it is used
     * to create another SpAIBinder object, it should first be incremented.
     */
    AIBinder *get() const { return mBinder; }

    /**
     * This allows the value in this class to be set from beneath it. If you
     * call this method and then change the value of T*, you must take ownership
     * of the value you are replacing and add ownership to the object that is
     * put in here.
     *
...
#define SP_AIBINDER_COMPARE(_op_)                           \
    static inline bool operator _op_(const SpAIBinder &lhs, \
    ...
    static inline bool operator _op_(const AIBinder *lhs,   \
                                     const SpAIBinder &rhs) \
    {                                                       \
...
public:
    ...
    /**
     * This returns the underlying object to be modified but does not affect
     * ownership.
     */
    T get() { return mT; }
 ...
 */
class ScopedAParcel
    : public impl::ScopedAResource<AParcel *, AParcel_delete, nullptr>
{
public:
    /**
 ...
 */
class ScopedAStatus
    : public impl::ScopedAResource<AStatus *, AStatus_delete, nullptr>
{
public:
    /**
     * Takes ownership of a.
    ...
    {
        return AStatus_getExceptionCode(get());
    }
    ...
    {
        return AStatus_getServiceSpecificError(get());
    }
        ...
        const char *message)
    {
        return ScopedAStatus(
            AStatus_fromExceptionCodeWithMessage(exception, message));
    }
...
public:
    ...
    ScopedAIBinder_DeathRecipient &operator=(ScopedAIBinder_DeathRecipient &&) =
        default;
};
 ...
 */
class ScopedAIBinder_Weak : public impl::ScopedAResource<AIBinder_Weak *,
...
public:
     ...
     * Takes ownership of a.
     */
    explicit ScopedAIBinder_Weak(AIBinder_Weak *a = nullptr)
        : ScopedAResource(a)
    {
    }
    ~ScopedAIBinder_Weak() {}
    ...
    {
        return SpAIBinder(AIBinder_Weak_promote(get()));
    }
};
...
class ScopedFileDescriptor
    : public impl::ScopedAResource<int, internal::closeWithError, -1>
{
public:
    /**
     * Takes ownership of a.
    ...
    {
        return ScopedFileDescriptor(::dup(get()));
    }
