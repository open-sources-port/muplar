...
public:
    ...
    virtual bool try_dispatch(uint32_t hvc_nr, const uint64_t regs[8], uint64_t* x0_out);
...
protected:
    ...
    static constexpr uint64_t HEAP_SIZE = 8 * 1024 * 1024; // 8MB for GLES/EGL stubs/objects
