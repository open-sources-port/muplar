...
//   slot 15 : GetMethodID       stub GPA
//   slot 29 : CallVoidMethod    stub GPA
//   slot 33 : CallIntMethod     stub GPA
//   slot 57 : NewStringUTF      stub GPA
//   slot 61 : GetStringUTFChars stub GPA
//   slot 62 : ReleaseStringUTFChars stub GPA
//   slot 167: RegisterNatives   stub GPA
//   slot 175: ExceptionCheck    stub GPA
//   slot 176: ExceptionClear    stub GPA
//   slot 24 : DeleteLocalRef    stub GPA
//   slot 184: NewByteArray      stub GPA
//   slot 191: GetByteArrayElements stub GPA
//   slot 194: ReleaseByteArrayElements stub GPA
//   slot 200: SetByteArrayRegion stub GPA
//
// Stubs live at stub_base_gpa + (call_nr - 0x1000) * 8.
// Each stub is 8 bytes: `mov x8, #call_nr ; hvc #5` — generated by the
// shim build step (same pattern as the Linux syscall shims).
// ────────────────────────────────────────────────────────────────────────────
void JniEnv::install_table(uint64_t table_gpa, uint64_t stub_base_gpa)
{
    ...
    auto stub = [&](uint32_t call_nr) -> uint64_t {
        return stub_base_gpa + (call_nr - 0x1000) * 8;
    };
...
JniEnv::install_entries(uint64_t stub_base_gpa) const
{
    ...
    return {
        ...
        { 15, stub(JNI_GetMethodID)             },
        { 24, stub(JNI_DeleteLocalRef)          },
        { 29, stub(JNI_CallVoidMethod)          },
        { 33, stub(JNI_CallIntMethod)           },
        { 57, stub(JNI_NewStringUTF)            },
        { 61, stub(JNI_GetStringUTFChars)       },
        { 62, stub(JNI_ReleaseStringUTFChars)   },
        {167, stub(JNI_RegisterNatives)         },
        {175, stub(JNI_ExceptionCheck)          },
        {176, stub(JNI_ExceptionClear)          },
        {184, stub(JNI_NewByteArray)            },
        {191, stub(JNI_GetByteArrayElements)    },
        {194, stub(JNI_ReleaseByteArrayElements)},
        {200, stub(JNI_SetByteArrayRegion)      },
    };
}
